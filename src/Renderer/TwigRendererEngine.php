...
final class TwigRendererEngine extends AbstractRendererEngine
{
     ...
     * {@inheritdoc}
     */
    public function renderBlock(BaseView $view, $resource, string $blockName, array $variables = []): string
    {
     ...
     */
    protected function loadResourceForBlockName(string $cacheKey, BaseView $view, string $blockName): bool
    {
        ...
        if ($view instanceof DatagridView) {
            ...
            if ($view instanceof CellView) {
                ...
                $parent = $view->datagrid;
            }

            // Proceed with the themes of the parent view
            $parentCacheKey = $parent->vars[self::CACHE_KEY_VAR];
